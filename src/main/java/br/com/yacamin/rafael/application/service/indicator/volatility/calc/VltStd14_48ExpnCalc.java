...
@Component
public class VltStd14_48ExpnCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_std_14_48_expn", "STD 14/48 Expn", "volatility", "max(ratio-1,0)", "Expansao STD 14 vs 48.", "0+", ""); }
}
