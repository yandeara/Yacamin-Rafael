...
/**
 * Percentile do Roll sobre uma janela.
 * percentile = count(source[i] <= current) / window
 */
public class RollPercentileExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public RollPercentileExtension(Indicator<Num> source, int window) {
