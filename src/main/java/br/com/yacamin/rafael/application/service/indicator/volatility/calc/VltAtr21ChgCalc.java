...
@Component
public class VltAtr21ChgCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_atr_21_chg", "ATR 21 Change", "volatility", "(atr[t]/atr[t-1])-1", "Variacao pct do ATR21.", "unbounded", ""); }
}
