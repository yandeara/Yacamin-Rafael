...
/**
 * Z-Score do Kyle Lambda sobre uma janela.
 * zscore = (current - mean) / std
 * Se std ~ 0, retorna 0.
 */
public class KyleZscoreExtension extends CachedIndicator<Num> {
    ...
    public KyleZscoreExtension(Indicator<Num> source, int window) {
