...
@Component
public class TrdDeltaCloseEma50AtrnCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                "trd_delta_close_ema_50_atrn", "Delta Close-EMA50 ATR-N", "trend", "(close - EMA50) / ATR14",
                "Delta assinado entre close e EMA 50 normalizado por ATR.",
                "unbounded", "close=110, EMA50=100, ATR=50 -> 10/50 = 0.2"
        );
    }
}
