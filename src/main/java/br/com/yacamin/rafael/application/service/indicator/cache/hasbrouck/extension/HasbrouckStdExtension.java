...
/**
 * Desvio padrao do Hasbrouck Lambda sobre uma janela.
 * STD(source, window) = sqrt(sum((x - mean)^2) / window)
 */
public class HasbrouckStdExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public HasbrouckStdExtension(Indicator<Num> source, int window) {
