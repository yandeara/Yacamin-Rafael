...
/**
 * Percentile rank sobre uma janela de qualquer source.
 * percentile = count(source[i] <= current) / window
 */
public class RangePercentileExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public RangePercentileExtension(Indicator<Num> source, int window) {
