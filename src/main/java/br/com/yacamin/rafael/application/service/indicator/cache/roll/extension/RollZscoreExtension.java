...
/**
 * Z-Score do Roll sobre uma janela.
 * zscore = (current - mean) / std
 * Se std ~ 0, retorna 0.
 */
public class RollZscoreExtension extends CachedIndicator<Num> {
    ...
    public RollZscoreExtension(Indicator<Num> source, int window) {
