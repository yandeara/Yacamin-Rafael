...
@Component
public class MomCntrate16Calc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                ...
                "momentum",
                "directional persistence of ret_1 over 16 bars",
                "Taxa de continuacao direcional nos ultimos 16 periodos. " +
                "Mede a persistencia do sinal do retorno (quantas vezes ret_1 manteve a mesma direcao).",
                "[0, 1]",
                "12 de 16 barras com mesmo sinal -> 0.75"
        );
    }
}
