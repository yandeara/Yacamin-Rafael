...
/**
 * Desvio padrao do body absoluto sobre uma janela.
 * STD(bodyAbs, window) = sqrt(sum((x - mean)^2) / window)
 */
public class BodyAbsStdExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public BodyAbsStdExtension(Indicator<Num> source, int window) {
