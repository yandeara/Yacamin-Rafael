...
@Component
public class RollSpreadAccW16Calc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                ...
                "Roll Spread Acceleration W16",
                "microstructure",
                "roll_spread(w=16)[t] - roll_spread(w=16)[t-1]",
                "Aceleracao do spread de Roll (janela 16). " +
