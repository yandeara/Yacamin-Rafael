...
@Component
public class MomWpr42DltCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                ...
                "momentum",
                "WPR(42)[t] - WPR(42)[t-1]",
                "Variacao absoluta do WPR(42) entre o candle atual e o anterior.",
                "unbounded (tipicamente -40 a 40)",
                "WPR(42) subiu de -80 para -60 -> delta = 20.0"
        );
    }
}
