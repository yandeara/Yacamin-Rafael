...
@Component
public class VolActTradesSp32Calc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vol_act_trades_sp_32", "Trades SP 32", "volume", "sustainedPressure(trades, 32)", "Pressao sustentada trades janela 32.", "-1..1", ""); }
}
