...
/**
 * Desvio padrao do Kyle Lambda sobre uma janela.
 * STD(source, window) = sqrt(sum((x - mean)^2) / window)
 */
public class KyleStdExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public KyleStdExtension(Indicator<Num> source, int window) {
