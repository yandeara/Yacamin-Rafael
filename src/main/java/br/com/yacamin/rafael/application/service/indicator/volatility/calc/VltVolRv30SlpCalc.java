...
@Component
public class VltVolRv30SlpCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_vol_rv_30_slp", "RV 30 Slp", "volatility", "slope(rv, 20)", "Slope RV 30.", "unbounded", ""); }
}
