...
@Component
public class MomTrix9HistCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                ...
                "TRIX(9) Histogram",
                "momentum",
                "TRIX(9) - EMA(9) of TRIX(9)",
                "Histograma do TRIX(9): diferenca entre TRIX e sua linha de sinal. Positivo=bullish, negativo=bearish.",
                "unbounded",
                "TRIX(9)=0.05, signal=0.03 -> hist=0.02 (bullish)"
        );
    }
}
