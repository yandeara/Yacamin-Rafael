...
@Component
public class VltVolGk32SlpCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_vol_gk_32_slp", "GK Vol 32 Slp", "volatility", "slope(gk, 20)", "Slope GK 32.", "unbounded", ""); }
}
