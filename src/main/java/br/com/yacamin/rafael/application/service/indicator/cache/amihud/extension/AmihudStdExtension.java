...
/**
 * Desvio padrao do Amihud ILLIQ sobre uma janela.
 * STD(amihud, window) = sqrt(sum((x - mean)^2) / window)
 */
public class AmihudStdExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public AmihudStdExtension(Indicator<Num> source, int window) {
