...
@Component
public class TrdDistCloseEma50AtrnCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                "trd_dist_close_ema_50_atrn", "Distance Close-EMA50 ATR-N", "trend", "|close - EMA50| / ATR14",
                "Distancia absoluta entre close e EMA 50 normalizada por ATR.",
                "0+", "close=100, EMA50=90, ATR=50 -> |10|/50 = 0.2"
        );
    }
}
