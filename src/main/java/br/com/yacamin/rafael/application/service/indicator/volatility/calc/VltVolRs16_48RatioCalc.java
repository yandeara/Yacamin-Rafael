...
@Component
public class VltVolRs16_48RatioCalc implements DescribableCalc {
    ...
    public static double calculate(BarSeries s, int idx) { return rs(s, idx, 16) / rs(s, idx, 48); }
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_vol_rs_16_48_ratio", "RS 16/48 Ratio", "volatility", "rs16/rs48", "Razao RS 16 vs 48.", "0+", ""); }
}
