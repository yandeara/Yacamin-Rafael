...
/**
 * Desvio padrao generico sobre uma janela.
 * STD(source, window) = sqrt(sum((x - mean)^2) / window)
 */
public class WickStdExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public WickStdExtension(Indicator<Num> source, int window) {
