...
@Component
public class VolActQuoteSp16Calc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vol_act_quote_sp_16", "Quote SP 16", "volume", "sustainedPressure(quote, 16)", "Pressao sustentada quote janela 16.", "-1..1", ""); }
}
