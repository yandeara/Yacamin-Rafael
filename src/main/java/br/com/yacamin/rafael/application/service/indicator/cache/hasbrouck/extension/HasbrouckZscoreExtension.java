...
/**
 * Z-Score do Hasbrouck Lambda sobre uma janela.
 * zscore = (current - mean) / std
 * Se std ~ 0, retorna 0.
 */
public class HasbrouckZscoreExtension extends CachedIndicator<Num> {
    ...
    public HasbrouckZscoreExtension(Indicator<Num> source, int window) {
