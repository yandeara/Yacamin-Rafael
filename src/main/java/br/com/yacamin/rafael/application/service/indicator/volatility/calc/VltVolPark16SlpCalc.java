...
@Component
public class VltVolPark16SlpCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_vol_park_16_slp", "PARK Vol 16 Slp", "volatility", "slope(park, 20)", "Slope PARK 16.", "unbounded", ""); }
}
