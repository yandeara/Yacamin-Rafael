...
/**
 * Percentile do Hasbrouck Lambda sobre uma janela.
 * percentile = count(source[i] <= current) / window
 */
public class HasbrouckPercentileExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public HasbrouckPercentileExtension(Indicator<Num> source, int window) {
