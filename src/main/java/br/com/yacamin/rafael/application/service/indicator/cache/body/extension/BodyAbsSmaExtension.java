...
/**
 * SMA do body absoluto sobre uma janela.
 * SMA(bodyAbs, window) = sum(bodyAbs[i-window+1..i]) / window
 */
public class BodyAbsSmaExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public BodyAbsSmaExtension(Indicator<Num> source, int window) {
