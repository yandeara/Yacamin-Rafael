...
@Component
public class VltStd14_50CmprCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_std_14_50_cmpr", "STD 14/50 Cmpr", "volatility", "max(1-ratio,0)", "Compressao STD 14 vs 50.", "0+", ""); }
}
