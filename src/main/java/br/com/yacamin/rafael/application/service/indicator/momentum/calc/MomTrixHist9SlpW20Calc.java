...
@Component
public class MomTrixHist9SlpW20Calc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                ...
                "TRIX Hist(9) Slope W20",
                "momentum",
                "linear_regression_slope(TRIX_hist_9, 20)",
                "Inclinacao do histograma TRIX(9) nos ultimos 20 periodos. Indica aceleracao do momentum TRIX curto.",
                "unbounded",
