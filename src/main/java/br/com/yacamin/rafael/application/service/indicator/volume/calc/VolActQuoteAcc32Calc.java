...
@Component
public class VolActQuoteAcc32Calc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vol_act_quote_acc_32", "Quote Acc 32", "volume", "pressureAcc(quote, 32)", "Acumulacao pressao quote janela 32.", "unbounded", ""); }
}
