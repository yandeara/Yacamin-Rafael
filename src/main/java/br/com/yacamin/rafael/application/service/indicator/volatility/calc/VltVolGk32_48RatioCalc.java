...
@Component
public class VltVolGk32_48RatioCalc implements DescribableCalc {
    ...
    public static double calculate(BarSeries s, int idx) { return gk(s, idx, 32) / gk(s, idx, 48); }
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_vol_gk_32_48_ratio", "GK 32/48 Ratio", "volatility", "gk32/gk48", "Razao GK 32 vs 48.", "0+", ""); }
}
