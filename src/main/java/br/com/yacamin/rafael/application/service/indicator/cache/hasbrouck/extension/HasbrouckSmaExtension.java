...
/**
 * SMA do Hasbrouck Lambda sobre uma janela.
 * SMA(source, window) = sum(source[i-window+1..i]) / window
 */
public class HasbrouckSmaExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public HasbrouckSmaExtension(Indicator<Num> source, int window) {
