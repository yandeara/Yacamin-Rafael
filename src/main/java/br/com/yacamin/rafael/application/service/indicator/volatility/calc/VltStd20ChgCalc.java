...
@Component
public class VltStd20ChgCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_std_20_chg", "STD 20 Chg", "volatility", "(std_t/std_t-1)-1", "Taxa de mudanca STD 20.", "unbounded", ""); }
}
