...
@Component
public class VltVolRs16SlpCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_vol_rs_16_slp", "RS Vol 16 Slp", "volatility", "slope(rs, 20)", "Slope RS 16.", "unbounded", ""); }
}
