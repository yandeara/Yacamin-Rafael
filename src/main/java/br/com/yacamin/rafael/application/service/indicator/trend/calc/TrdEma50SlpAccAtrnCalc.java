...
@Component
public class TrdEma50SlpAccAtrnCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                "trd_ema_50_slp_acc_atrn", "EMA 50 Slope Acc ATR-Normalized", "trend", "slopeAcc(EMA50) / ATR14",
                "Aceleracao do slope da EMA 50 normalizada pela volatilidade.",
