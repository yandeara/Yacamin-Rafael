...
/**
 * SMA sobre uma janela de qualquer source (Range, HLC3, LogRange, etc.).
 * SMA(source, window) = sum(source[i-window+1..i]) / window
 */
public class RangeSmaExtension extends CachedIndicator<Num> {

    private final Indicator<Num> source;
    private final int window;

    public RangeSmaExtension(Indicator<Num> source, int window) {
