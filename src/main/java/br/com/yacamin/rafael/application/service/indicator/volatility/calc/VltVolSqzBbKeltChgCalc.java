...
@Component
public class VltVolSqzBbKeltChgCalc implements DescribableCalc {
    ...
    @Override public FeatureDescription describe() { return new FeatureDescription("vlt_vol_sqz_bb_kelt_chg", "Squeeze Chg ", "volatility", "sqz(t)/sqz(t-1)-1", "Squeeze change.", "unbounded", ""); }
}
