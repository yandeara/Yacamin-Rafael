...
@Component
public class TrdDeltaCloseEma20AtrnCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                "trd_delta_close_ema_20_atrn", "Delta Close-EMA20 ATR-N", "trend", "(close - EMA20) / ATR14",
                "Delta assinado entre close e EMA 20 normalizado por ATR.",
                "unbounded", "close=105, EMA20=100, ATR=50 -> 5/50 = 0.1"
        );
    }
}
