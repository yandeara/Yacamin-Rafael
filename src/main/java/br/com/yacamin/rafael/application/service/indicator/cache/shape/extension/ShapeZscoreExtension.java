...
/**
 * Z-Score generico para indicadores de shape sobre uma janela.
 * zscore = (current - mean) / std
 * Se std ~ 0, retorna 0.
 */
public class ShapeZscoreExtension extends CachedIndicator<Num> {
    ...
    public ShapeZscoreExtension(Indicator<Num> source, int window) {
