...
@Component
public class TrdDistCloseEma8AtrnCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                "trd_dist_close_ema_8_atrn", "Distance Close-EMA8 ATR-N", "trend", "|close - EMA8| / ATR14",
                "Distancia absoluta entre close e EMA 8 normalizada por ATR. Mede afastamento do preco em relacao a media rapida.",
                "0+", "close=100, EMA8=98, ATR=50 -> |2|/50 = 0.04"
        );
    }
}
