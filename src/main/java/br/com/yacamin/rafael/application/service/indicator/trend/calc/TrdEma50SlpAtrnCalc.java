...
@Component
public class TrdEma50SlpAtrnCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                "trd_ema_50_slp_atrn", "EMA 50 Slope ATR-Normalized", "trend", "slope(EMA50) / ATR14",
                "Slope da EMA 50 normalizado pela volatilidade (ATR14).",
