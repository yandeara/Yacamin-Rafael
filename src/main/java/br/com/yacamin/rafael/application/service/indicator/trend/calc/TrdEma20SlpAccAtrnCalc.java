...
@Component
public class TrdEma20SlpAccAtrnCalc implements DescribableCalc {
    ...
    public FeatureDescription describe() {
        return new FeatureDescription(
                "trd_ema_20_slp_acc_atrn", "EMA 20 Slope Acc ATR-Normalized", "trend", "slopeAcc(EMA20) / ATR14",
                "Aceleracao do slope da EMA 20 normalizada pela volatilidade.",
