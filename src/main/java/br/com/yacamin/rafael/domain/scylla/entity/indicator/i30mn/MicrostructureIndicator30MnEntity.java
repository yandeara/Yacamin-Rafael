...
@Getter
@Entity
@Table(name = "microstructure_indicator_30_mn")
@IdClass(IndicatorKey.class)
public class MicrostructureIndicator30MnEntity implements MicrostructureIndicatorEntity {
    ...
    // -------------------------------------------------------------------------
    @Column(name = "mic_roll_cov_w16")  private double mic_roll_cov_w16;
    @Column(name = "mic_roll_cov_w32")  private double mic_roll_cov_w32;
    @Column(name = "mic_roll_cov_w96")  private double mic_roll_cov_w96;
    @Column(name = "mic_roll_cov_w512") private double mic_roll_cov_w512;

    @Column(name = "mic_roll_cov_w48")  private double mic_roll_cov_w48;
    @Column(name = "mic_roll_cov_w336") private double mic_roll_cov_w336;
    @Column(name = "mic_roll_cov_w672") private double mic_roll_cov_w672;

    // -------------------------------------------------------------------------
    // 1.1.1 ROLL COVARIANCE — PERCENT
    // -------------------------------------------------------------------------
    @Column(name = "mic_roll_cov_pct_w16")  private double mic_roll_cov_pct_w16;
    @Column(name = "mic_roll_cov_pct_w32")  private double mic_roll_cov_pct_w32;
    @Column(name = "mic_roll_cov_pct_w96")  private double mic_roll_cov_pct_w96;
    @Column(name = "mic_roll_cov_pct_w512") private double mic_roll_cov_pct_w512;

    @Column(name = "mic_roll_cov_pct_w48")  private double mic_roll_cov_pct_w48;
    @Column(name = "mic_roll_cov_pct_w336") private double mic_roll_cov_pct_w336;
    @Column(name = "mic_roll_cov_pct_w672") private double mic_roll_cov_pct_w672;

    // -------------------------------------------------------------------------
    // 1.1.2 ROLL COVARIANCE — PERCENT ZSCORE
    // -------------------------------------------------------------------------
    @Column(name = "mic_roll_cov_pct_zsc_w16")  private double mic_roll_cov_pct_zsc_w16;
    @Column(name = "mic_roll_cov_pct_zsc_w32")  private double mic_roll_cov_pct_zsc_w32;
    @Column(name = "mic_roll_cov_pct_zsc_w96")  private double mic_roll_cov_pct_zsc_w96;
    @Column(name = "mic_roll_cov_pct_zsc_w512") private double mic_roll_cov_pct_zsc_w512;

    @Column(name = "mic_roll_cov_pct_zsc_w48")  private double mic_roll_cov_pct_zsc_w48;
    @Column(name = "mic_roll_cov_pct_zsc_w336") private double mic_roll_cov_pct_zsc_w336;
    @Column(name = "mic_roll_cov_pct_zsc_w672") private double mic_roll_cov_pct_zsc_w672;

    // -------------------------------------------------------------------------
    // 1.1.3 ROLL COVARIANCE — RAW ZSCORE
    // -------------------------------------------------------------------------
    @Column(name = "mic_roll_cov_zsc_w16")  private double mic_roll_cov_zsc_w16;
    @Column(name = "mic_roll_cov_zsc_w32")  private double mic_roll_cov_zsc_w32;
    @Column(name = "mic_roll_cov_zsc_w96")  private double mic_roll_cov_zsc_w96;
    @Column(name = "mic_roll_cov_zsc_w512") private double mic_roll_cov_zsc_w512;

    @Column(name = "mic_roll_cov_zsc_w48")  private double mic_roll_cov_zsc_w48;
    @Column(name = "mic_roll_cov_zsc_w336") private double mic_roll_cov_zsc_w336;
    @Column(name = "mic_roll_cov_zsc_w672") private double mic_roll_cov_zsc_w672;

    // =========================================================================
    // 1.2 ROLL SPREAD [Janelado: 16, 32. 96 e 512]
    // =========================================================================
    @Column(name = "mic_roll_spread_w16")
    private double mic_roll_spread_w16;

    @Column(name = "mic_roll_spread_w32")
    private double mic_roll_spread_w32;

    @Column(name = "mic_roll_spread_w96")
    private double mic_roll_spread_w96;

    @Column(name = "mic_roll_spread_w512")
    private double mic_roll_spread_w512;

    @Column(name = "mic_roll_spread_w48")
    private double mic_roll_spread_w48;

    @Column(name = "mic_roll_spread_w336")
    private double mic_roll_spread_w336;

    @Column(name = "mic_roll_spread_w672")
    private double mic_roll_spread_w672;

    // =========================================================================
    // 1.2.2 ROLL SPREAD ATR-N
    // =========================================================================
    @Column(name = "mic_roll_spread_atrn14_w16")
    private double mic_roll_spread_atrn14_w16;

    @Column(name = "mic_roll_spread_atrn14_w32")
    private double mic_roll_spread_atrn14_w32;

    @Column(name = "mic_roll_spread_atrn14_w96")
    private double mic_roll_spread_atrn14_w96;

    @Column(name = "mic_roll_spread_atrn14_w512")
    private double mic_roll_spread_atrn14_w512;

    @Column(name = "mic_roll_spread_atrn14_w48")
    private double mic_roll_spread_atrn14_w48;

    @Column(name = "mic_roll_spread_atrn14_w336")
    private double mic_roll_spread_atrn14_w336;

    @Column(name = "mic_roll_spread_atrn14_w672")
    private double mic_roll_spread_atrn14_w672;

    // =========================================================================
    // 1.2.2 ROLL SPREAD PCT - PERCENT
    // =========================================================================
    @Column(name = "mic_roll_spread_pct_w16")
    private double mic_roll_spread_pct_w16;

    @Column(name = "mic_roll_spread_pct_w32")
    private double mic_roll_spread_pct_w32;

    @Column(name = "mic_roll_spread_pct_w96")
    private double mic_roll_spread_pct_w96;

    @Column(name = "mic_roll_spread_pct_w512")
    private double mic_roll_spread_pct_w512;

    @Column(name = "mic_roll_spread_pct_w48")
    private double mic_roll_spread_pct_w48;

    @Column(name = "mic_roll_spread_pct_w336")
    private double mic_roll_spread_pct_w336;

    @Column(name = "mic_roll_spread_pct_w672")
    private double mic_roll_spread_pct_w672;

    // =========================================================================
    // 1.2.2.1 ROLL SPREAD PCT ATR-N
    // =========================================================================
    @Column(name = "mic_roll_spread_pct_atrn14_w16")
    private double mic_roll_spread_pct_atrn14_w16;

    @Column(name = "mic_roll_spread_pct_atrn14_w32")
    private double mic_roll_spread_pct_atrn14_w32;

    @Column(name = "mic_roll_spread_pct_atrn14_w96")
    private double mic_roll_spread_pct_atrn14_w96;

    @Column(name = "mic_roll_spread_pct_atrn14_w512")
    private double mic_roll_spread_pct_atrn14_w512;

    @Column(name = "mic_roll_spread_pct_atrn14_w48")
    private double mic_roll_spread_pct_atrn14_w48;

    @Column(name = "mic_roll_spread_pct_atrn14_w336")
    private double mic_roll_spread_pct_atrn14_w336;

    @Column(name = "mic_roll_spread_pct_atrn14_w672")
    private double mic_roll_spread_pct_atrn14_w672;

    // =========================================================================
    // 1.2.2 ROLL SPREAD ACCELERATION
    // =========================================================================
    @Column(name = "mic_roll_spread_acc_w16")
    private double mic_roll_spread_acc_w16;

    @Column(name = "mic_roll_spread_acc_w32")
    private double mic_roll_spread_acc_w32;

    @Column(name = "mic_roll_spread_acc_w96")
    private double mic_roll_spread_acc_w96;

    @Column(name = "mic_roll_spread_acc_w512")
    private double mic_roll_spread_acc_w512;

    @Column(name = "mic_roll_spread_acc_w48")
    private double mic_roll_spread_acc_w48;

    @Column(name = "mic_roll_spread_acc_w336")
    private double mic_roll_spread_acc_w336;

    @Column(name = "mic_roll_spread_acc_w672")
    private double mic_roll_spread_acc_w672;

    // =========================================================================
    // 1.2.3 ROLL SPREAD SLOPE
    // =========================================================================
    @Column(name = "mic_roll_spread_slp_w16")
    private double mic_roll_spread_slp_w16;

    @Column(name = "mic_roll_spread_slp_w32")
    private double mic_roll_spread_slp_w32;

    @Column(name = "mic_roll_spread_slp_w96")
    private double mic_roll_spread_slp_w96;

    @Column(name = "mic_roll_spread_slp_w512")
    private double mic_roll_spread_slp_w512;

    @Column(name = "mic_roll_spread_slp_w48")
    private double mic_roll_spread_slp_w48;

    @Column(name = "mic_roll_spread_slp_w336")
    private double mic_roll_spread_slp_w336;

    @Column(name = "mic_roll_spread_slp_w672")
    private double mic_roll_spread_slp_w672;

    // =========================================================================
    // ROLL SPREAD SMOOTHING
    // =========================================================================
    @Column(name = "mic_roll_spread_ma_w16")
    private double mic_roll_spread_ma_w16;

    @Column(name = "mic_roll_spread_ma_w32")
    private double mic_roll_spread_ma_w32;

    @Column(name = "mic_roll_spread_ma_w96")
    private double mic_roll_spread_ma_w96;

    @Column(name = "mic_roll_spread_ma_w512")
    private double mic_roll_spread_ma_w512;

    @Column(name = "mic_roll_spread_ma_w48")
    private double mic_roll_spread_ma_w48;

    @Column(name = "mic_roll_spread_ma_w336")
    private double mic_roll_spread_ma_w336;

    @Column(name = "mic_roll_spread_ma_w672")
    private double mic_roll_spread_ma_w672;

    // =========================================================================
    // ROLL SPREAD PERSISTENCE (proporção de spreads > 0)
    // =========================================================================
    @Column(name = "mic_roll_spread_prst_w16")
    private double mic_roll_spread_prst_w16;

    @Column(name = "mic_roll_spread_prst_w32")
    private double mic_roll_spread_prst_w32;

    @Column(name = "mic_roll_spread_prst_w96")
    private double mic_roll_spread_prst_w96;

    @Column(name = "mic_roll_spread_prst_w512")
    private double mic_roll_spread_prst_w512;

    @Column(name = "mic_roll_spread_prst_w48")
    private double mic_roll_spread_prst_w48;

    @Column(name = "mic_roll_spread_prst_w336")
    private double mic_roll_spread_prst_w336;

    @Column(name = "mic_roll_spread_prst_w672")
    private double mic_roll_spread_prst_w672;

    // =========================================================================
    // ROLL SPREAD ZScore
    // =========================================================================
    @Column(name = "mic_roll_spread_zsc_w16")
    private double mic_roll_spread_zsc_w16;

    @Column(name = "mic_roll_spread_zsc_w32")
    private double mic_roll_spread_zsc_w32;

    @Column(name = "mic_roll_spread_zsc_w96")
    private double mic_roll_spread_zsc_w96;

    @Column(name = "mic_roll_spread_zsc_w512")
    private double mic_roll_spread_zsc_w512;

    @Column(name = "mic_roll_spread_zsc_w48")
    private double mic_roll_spread_zsc_w48;

    @Column(name = "mic_roll_spread_zsc_w336")
    private double mic_roll_spread_zsc_w336;

    @Column(name = "mic_roll_spread_zsc_w672")
    private double mic_roll_spread_zsc_w672;

    // =========================================================================
    // ROLL SPREAD PCT ZScore
    // =========================================================================
    @Column(name = "mic_roll_spread_pct_zsc_w16")
    private double mic_roll_spread_pct_zsc_w16;

    @Column(name = "mic_roll_spread_pct_zsc_w32")
    private double mic_roll_spread_pct_zsc_w32;

    @Column(name = "mic_roll_spread_pct_zsc_w96")
    private double mic_roll_spread_pct_zsc_w96;

    @Column(name = "mic_roll_spread_pct_zsc_w512")
    private double mic_roll_spread_pct_zsc_w512;

    @Column(name = "mic_roll_spread_pct_zsc_w48")
    private double mic_roll_spread_pct_zsc_w48;

    @Column(name = "mic_roll_spread_pct_zsc_w336")
    private double mic_roll_spread_pct_zsc_w336;

    @Column(name = "mic_roll_spread_pct_zsc_w672")
    private double mic_roll_spread_pct_zsc_w672;

    // =========================================================================
    // 1.2.6 ROLL SPREAD DIVERGENCE (Zraw - Zpct)
    // =========================================================================
    @Column(name = "mic_roll_spread_dvgc_w16")
    private double mic_roll_spread_dvgc_w16;

    @Column(name = "mic_roll_spread_dvgc_w32")
    private double mic_roll_spread_dvgc_w32;

    @Column(name = "mic_roll_spread_dvgc_w96")
    private double mic_roll_spread_dvgc_w96;

    @Column(name = "mic_roll_spread_dvgc_w512")
    private double mic_roll_spread_dvgc_w512;

    @Column(name = "mic_roll_spread_dvgc_w48")
    private double mic_roll_spread_dvgc_w48;

    @Column(name = "mic_roll_spread_dvgc_w336")
    private double mic_roll_spread_dvgc_w336;

    @Column(name = "mic_roll_spread_dvgc_w672")
    private double mic_roll_spread_dvgc_w672;

    // =========================================================================
    // 1.2.6 ROLL SPREAD VOLATILITY
    // =========================================================================
    @Column(name = "mic_roll_spread_vol_w16")
    private double mic_roll_spread_vol_w16;

    @Column(name = "mic_roll_spread_vol_w32")
    private double mic_roll_spread_vol_w32;

    @Column(name = "mic_roll_spread_vol_w96")
    private double mic_roll_spread_vol_w96;

    @Column(name = "mic_roll_spread_vol_w512")
    private double mic_roll_spread_vol_w512;

    @Column(name = "mic_roll_spread_vol_w48")
    private double mic_roll_spread_vol_w48;

    @Column(name = "mic_roll_spread_vol_w336")
    private double mic_roll_spread_vol_w336;

    @Column(name = "mic_roll_spread_vol_w672")
    private double mic_roll_spread_vol_w672;

    // =========================================================================
    // 1.2.6 ROLL SPREAD PERCENTILE
    // =========================================================================
    @Column(name = "mic_roll_spread_pctile_w16")
    private double mic_roll_spread_pctile_w16;

    @Column(name = "mic_roll_spread_pctile_w32")
    private double mic_roll_spread_pctile_w32;

    @Column(name = "mic_roll_spread_pctile_w96")
    private double mic_roll_spread_pctile_w96;

    @Column(name = "mic_roll_spread_pctile_w512")
    private double mic_roll_spread_pctile_w512;

    @Column(name = "mic_roll_spread_pctile_w48")
    private double mic_roll_spread_pctile_w48;

    @Column(name = "mic_roll_spread_pctile_w336")
    private double mic_roll_spread_pctile_w336;

    @Column(name = "mic_roll_spread_pctile_w672")
    ...
    // ==========================================================================
    // w4
    @Column(name = "mic_kyle_lambda_w4_slp_w4")
    private double mic_kyle_lambda_w4_slp_w4;

    @Column(name = "mic_kyle_lambda_w4_slp_w20")
    private double mic_kyle_lambda_w4_slp_w20;

    @Column(name = "mic_kyle_lambda_w4_slp_w50")
    private double mic_kyle_lambda_w4_slp_w50;

    // w16
    @Column(name = "mic_kyle_lambda_w16_slp_w4")
    private double mic_kyle_lambda_w16_slp_w4;

    @Column(name = "mic_kyle_lambda_w16_slp_w20")
    private double mic_kyle_lambda_w16_slp_w20;

    @Column(name = "mic_kyle_lambda_w16_slp_w50")
    private double mic_kyle_lambda_w16_slp_w50;

    // w96
    @Column(name = "mic_kyle_lambda_w96_slp_w4")
    private double mic_kyle_lambda_w96_slp_w4;

    @Column(name = "mic_kyle_lambda_w96_slp_w20")
    private double mic_kyle_lambda_w96_slp_w20;

    @Column(name = "mic_kyle_lambda_w96_slp_w50")
    private double mic_kyle_lambda_w96_slp_w50;

    // w200
    @Column(name = "mic_kyle_lambda_w200_slp_w4")
    private double mic_kyle_lambda_w200_slp_w4;

    @Column(name = "mic_kyle_lambda_w200_slp_w20")
    private double mic_kyle_lambda_w200_slp_w20;

    @Column(name = "mic_kyle_lambda_w200_slp_w50")
    ...
    // BASE RAW
    // --------------------------------------------------------------------------
    @Column(name = "mic_kyle_lambda_w48")
    private double mic_kyle_lambda_w48;

    @Column(name = "mic_kyle_lambda_w288")
    private double mic_kyle_lambda_w288;

    // --------------------------------------------------------------------------
    // Z-SCORE (zW 20)
    // --------------------------------------------------------------------------
    @Column(name = "mic_kyle_lambda_w48_zsc_20")
    private double mic_kyle_lambda_w48_zsc_20;

    @Column(name = "mic_kyle_lambda_w288_zsc_20")
    private double mic_kyle_lambda_w288_zsc_20;

    // --------------------------------------------------------------------------
    // RELATIVE (10, 40)
    // --------------------------------------------------------------------------
    @Column(name = "mic_kyle_lambda_w48_rel_10")
    private double mic_kyle_lambda_w48_rel_10;

    @Column(name = "mic_kyle_lambda_w48_rel_40")
    private double mic_kyle_lambda_w48_rel_40;

    @Column(name = "mic_kyle_lambda_w288_rel_10")
    private double mic_kyle_lambda_w288_rel_10;

    @Column(name = "mic_kyle_lambda_w288_rel_40")
    ...
    // --------------------------------------------------------------------------
    // w48
    @Column(name = "mic_kyle_lambda_w48_slp_w4")
    private double mic_kyle_lambda_w48_slp_w4;

    @Column(name = "mic_kyle_lambda_w48_slp_w20")
    private double mic_kyle_lambda_w48_slp_w20;

    @Column(name = "mic_kyle_lambda_w48_slp_w50")
    private double mic_kyle_lambda_w48_slp_w50;

    // w288
    @Column(name = "mic_kyle_lambda_w288_slp_w4")
    private double mic_kyle_lambda_w288_slp_w4;

    @Column(name = "mic_kyle_lambda_w288_slp_w20")
    private double mic_kyle_lambda_w288_slp_w20;

    @Column(name = "mic_kyle_lambda_w288_slp_w50")
    ...
    // --------------------------------------------------------------------------
    // w48
    @Column(name = "mic_kyle_lambda_w48_acc_w4")
    private double mic_kyle_lambda_w48_acc_w4;

    @Column(name = "mic_kyle_lambda_w48_acc_w5")
    private double mic_kyle_lambda_w48_acc_w5;

    @Column(name = "mic_kyle_lambda_w48_acc_w10")
    private double mic_kyle_lambda_w48_acc_w10;

    @Column(name = "mic_kyle_lambda_w48_acc_w16")
    private double mic_kyle_lambda_w48_acc_w16;

    // w288
    @Column(name = "mic_kyle_lambda_w288_acc_w4")
    private double mic_kyle_lambda_w288_acc_w4;

    @Column(name = "mic_kyle_lambda_w288_acc_w5")
    private double mic_kyle_lambda_w288_acc_w5;

    @Column(name = "mic_kyle_lambda_w288_acc_w10")
    private double mic_kyle_lambda_w288_acc_w10;

    @Column(name = "mic_kyle_lambda_w288_acc_w16")
    ...
    // --------------------------------------------------------------------------
    // w48
    @Column(name = "mic_kyle_lambda_w48_ma_10")
    private double mic_kyle_lambda_w48_ma_10;

    @Column(name = "mic_kyle_lambda_w48_ma_20")
    private double mic_kyle_lambda_w48_ma_20;

    @Column(name = "mic_kyle_lambda_w48_ma_30")
    private double mic_kyle_lambda_w48_ma_30;

    // w288
    @Column(name = "mic_kyle_lambda_w288_ma_10")
    private double mic_kyle_lambda_w288_ma_10;

    @Column(name = "mic_kyle_lambda_w288_ma_20")
    private double mic_kyle_lambda_w288_ma_20;

    @Column(name = "mic_kyle_lambda_w288_ma_30")
    ...
    // (range / MA(range, 20))
    @Column(name = "mic_range_squeeze_w20")
    ...
    @Column(name = "mic_range_asymmetry")
    ...
    @Column(name = "mic_range_headroom_atr")
    ...
    // --------------------------------------------------------------------------
    @Column(name = "mic_tr_range_ratio")
    ...
    // --------------------------------------------------------------------------
    @Column(name = "mic_log_range_pctile_w48")
    ...
    // --------------------------------------------------------------------------
    @Column(name = "mic_range_regime_state")
...
// --------------------------------------------------------------------------
    ...
    @Column(name = "mic_candle_balance_score")
...
// --------------------------------------------------------------------------
    @Column(name = "mic_close_to_high_norm")
    private double mic_close_to_high_norm;            // (high - close) / range

    @Column(name = "mic_close_to_low_norm")
...
// --------------------------------------------------------------------------
    @Column(name = "mic_balance_state")
    private double mic_balance_state;

    // --------------------------------------------------------------------------
// TRIANGLE SCORE (regime-aware / ATR-N)
// --------------------------------------------------------------------------
    @Column(name = "mic_close_triangle_score_atrn")
    ...
    @Column(name = "mic_return_dominance_ratio")
